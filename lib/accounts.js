...
function accounts (baseUrl, cors, func) {
  ...
  return {
     ...
     * @return {promise}
     */
    updateUserRole: function(userId, roleId, organisationId) {
      var data = roleObj(roleId);
     ...
     * @param {string} orgId - an existing organisation ID
     * @param {string} userId - an existing user ID
     * @param {string} join_state - Join state to update
     * @return {promise}
     */
    updateJoinOrganisation: function (orgId, userId, join_state) {
      var data = {
